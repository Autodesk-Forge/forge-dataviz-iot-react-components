    ...
    function createLabel(node) {
        if (node.children.length > 0) {
            return <React.Fragment>
                <Typography component="div" noWrap={true}>{node.name}</Typography>
            </React.Fragment>
        }
        else {
            return <div className="leafName">
                                    ...
                                    <Typography id="settings-typography" component="div">
                                        ...
                                        <div className="radio-selection-form">
                                            ...
                                            >
                                                <FormControlLabel
                                                    value={true}
                                                    control={<CustomRadio size="small" color="default" />}
                                                    label="Occluded view"
                                                />
                                        ...
                                        <FormGroup className="form-group">
                                            <FormLabel component="legend" id="form-label-hm">Heatmap Types</FormLabel>
                                            <RadioGroup className="hm-radio-group"
                                                name="heatmapType"
